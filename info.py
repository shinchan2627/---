...
PICS = (environ.get('PICS', 'https://telegra.ph/file/4df46facb0cf1552bc364.jpg')).split()
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MRSupport')
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'https://linkpays.in')
