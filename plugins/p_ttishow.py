        ...
        if settings["🆆🅴🅻🅲🅾🅼🅴"]:
            for u in message.new_chat_members:
                if (temp.MELCOW).get('🆆🅴🅻🅲🅾🅼🅴') is not None:
                    try:
                        await (temp.MELCOW['🆆🅴🅻🅲🅾🅼🅴']).delete()
                    except:
                        pass
                temp.MELCOW['🆆🅴🅻🅲🅾🅼🅴'] = await message.reply_photo(
                photo="https://telegra.ph/file/4df46facb0cf1552bc364.jpg",                                               
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🔥  ↭ Main Channel ↭  🔥', url='https://t.me/tamcinemas') ],
                                                                                      [ InlineKeyboardButton('🔥  ↭ Link Group ↭  🔥', url='https://t.me/+0TBKVN0Z6yM1MTc1') ]
                                                                                    ] )
                )
