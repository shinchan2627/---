...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/tamcinemas"),
            ],
            [
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('【sᴜʙsᴄʀɪʙᴇ】', url='https://t.me/tamcinemas')],  [InlineKeyboardButton('Join', url='https://t.me/+0TBKVN0Z6yM1MTc1')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
